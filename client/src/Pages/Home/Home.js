  ...
  return (
    <div className="home">
      ...
      <div className="" >
        ...
        <div>
          <p className="d-flex justify-content-center">Our websites may also offer services such as online pet stores, pet adoption, pet sitting, and veterinary care directories.</p>
        </div>
        <br></br>
        <br></br>
        <br></br>
